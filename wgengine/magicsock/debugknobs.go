...
var (
	...
	// debugPMTUD enables the peer MTU feature, which does path MTU
	// discovery on UDP connections between peers.
	debugPMTUD = envknob.RegisterOptBool("TS_DEBUG_ENABLE_PMTUD")
